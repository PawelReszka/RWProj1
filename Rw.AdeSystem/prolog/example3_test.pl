...
test(turn1_mietus_0) :-
    ...
    resAb(turn1, mietus, state0, []),
    resN_trunc(turn1,mietus,state0,[state1]),
    resAb_trunc(turn1, mietus, state0, []).
...
test(turn2_hador_0) :-
    ...
    resAb(turn2, hador, state0, []),
    resN_trunc(turn2,hador,state0,[state3]),
    resAb_trunc(turn2, hador, state0, []).
...
test(turn2_hador_1) :-
    ...
    resN(turn2,hador,state1,[state3]),
    resAb(turn2, hador, state1, []),
    resN_trunc(turn2,hador,state1,[state3]),
    resAb_trunc(turn2, hador, state1, []).
