...
test(chown_hador_0) :-
	%te linijki sa po te zeby zeby moc przeprowadzic testy na dowolnym stanie =  sa po to zeby sie nie czepial prolog
  	state(state0, S0),
    state(state2, S2),
    state(state4, S4),
    state(state6, S6),
    ...
    sort(S5,STATE5),
    sort(S7,STATE7),
    STATE0=STATE0, STATE1=STATE1, STATE2=STATE2, STATE3=STATE3, STATE4=STATE4, STATE5=STATE5, STATE6=STATE6, STATE7=STATE7,
